  ...
  switch (boardID)
  {
   ...
   case 31:
	...
	// #endif
		...
		pinCoil5 = PE2; //Pin for coil 5
		pinCoil6 = PE3; //Pin for coil 6
		//   pinCoil7 = PE0; //Pin for coil 7 (placeholder)
		//   pinCoil8 = PB9; //Pin for coil 8 (placeholder)
		pinTrigger = PD3; //The CAS pin
		pinTrigger2 = PD4; //The Cam Sensor pin
		...
		pinBaro = PA7; //Baro sensor pin - Placeholder
		pinDisplayReset = PB7; // OLED reset pin
		pinTachOut = PC9; //Tacho output pin  (Goes to ULN2003)
		pinIdle1 = PD10; //IACV pin1
		pinIdle2 = PE9; //IACV pin2
		pinBoost = PE2; //Boost control - Placeholder
		pinVVT_1 = PE3; //VVT1 output (intake vanos) - Placeholder
		pinVVT_2 = PD5; //VVT2 output (exhaust vanos) - Placeholder
		pinFuelPump = PC8; //Fuel pump output  (Goes to ULN2003)
		pinStepperDir = PD12; //Stepper valve isn't used with these - Placeholder
		pinStepperStep = PD15; //Stepper valve isn't used with these - Placeholder
		pinStepperEnable = PD14; //Stepper valve isn't used with these - Placeholder
		pinFan = PA15; //Pin for the fan output (Goes to ULN2003)
		pinLaunch = PE13; //Launch control pin - for v.1.1 board
		pinFlex = PD11; // Flex sensor - Placeholder
		pinResetControl = PB7; //Reset control output
		pinVSS = PD7; //VSS input pin
		pinWMIEmpty = PC4; //(placeholder)
		pinWMIIndicator = PC3; //(placeholder)
		pinWMIEnabled = PC2; //(placeholder)
		pinIdleUp = PD6; //(placeholder)
